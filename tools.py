...
def twitter_api():
    CONSUMER_KEY    = os.environ['g9jBJoiHQWLS7EuGrjdTcpZn4']
    CONSUMER_SECRET = os.environ['GbUXMtmEpfKndtvTsNbVAD2AsxYOdPUA9KyadpfsbQGHgX1s9u']
    ACCESSS_TOKEN   = os.environ['1260924422375870466-fYAlbjC8eDBHmW2WHFktxcvjRhfcPE']
    ACCESS_SECRET   = os.environ['6Wu994g6viJK6lcjHeooUgykPEOs8btoan30JTV3vvzZW']
